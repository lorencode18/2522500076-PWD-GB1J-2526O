  ...
  <main>
    ...
    <section id="contact">
      ...
      <?php if (!empty($flash_sukses)) : ?>
        <div style="padding:10px; margin-bottom:10px; background:#d4edda; color:#155724; border-radius:5px;">
          <?= $flash_sukses; ?>
        </div>
      <?php endif; ?>

      <?php if (!empty($flash_error)) : ?>
        <div style="padding:10px; margin-bottom:10px; background:#f8d7da; color:#721c24; border-radius:5px;">
          <?= $flash_error; ?>
        </div>
      <?php endif; ?>
      ...
      <form action="proses.php" method="POST">
        ...
        <label for="txtCaptcha">
          ...
          placeholder="Jawaban captcha" required>
        </label>
