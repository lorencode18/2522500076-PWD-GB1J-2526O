...
<body>
    ...
    <main>
        ...
        <section id="IPK">
            ...
            ?>
            <h2></h2>
            <p><strong>Total Bobot </strong><b>:</b><?php echo $totalBobot ?></p>
            <p><strong>Total SKS </strong><b>:</b><?php echo $totalSKS ?></p>
            <p><strong>IPK </strong><b>:</b><?php echo number_format ($IPK,2) ?></p>
        </section>    
